            ...
            <div class="col-md-3 col-sm-6">
                <div class="footer-menu footer-menu-001">
                    <div class="footer-intro mb-4">
                        <a class="navbar-brand brand-logo"  href="{{ url('/') }}"><img src="{{ asset('assets/logo/logo-panjang.svg') }}" style="height: 60px" alt="logo" /></a>
                    </div>
                    <p>
                       Stoffa adalah sebuah toko online kain yang menyediakan berbagai macam jenis kain dengan kualitas terbaik.
                    </p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center text-md-start">
                    <p>
                        © Copyright 2025 Stoffa. All rights reserved. Design by
                        <a href="#" target="_blank">CindyMarcellina</a>
                    </p>
                </div>
            </div>
        </div>
